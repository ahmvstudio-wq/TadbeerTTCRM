...
-- Insert demo users (these are NOT linked to auth.users - just CRM profile data)
INSERT INTO users (id, full_name, email, role) VALUES
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Ahmed Al-Rashid', 'ahmed@tadbeer.com', 'admin'),
  ('b2c3d4e5-f6a7-8901-bcde-f12345678901', 'Ismail Khan', 'ismail@tadbeer.com', 'closer'),
  ('c3d4e5f6-a7b8-9012-cdef-123456789012', 'Fatima Hassan', 'fatima@tadbeer.com', 'bd_rep');
